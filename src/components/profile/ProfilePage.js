              ...
              <div className="panel panel-info">
                ...
                <div className="panel-footer">
                  ...
                  <span className="pull-right">
                    <a href="profile/edit" data-original-title="Edit this user" data-toggle="tooltip" type="button" className="btn btn-sm btn-warning"><i className="glyphicon glyphicon-edit"></i></a>
